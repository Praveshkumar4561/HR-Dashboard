...
const Sidebar = () => {
  ...
  const handleLogout = async () => {
    try {
      await axios.post(
        "http://localhost:2100/api/logout",
        {},
  ...
  return (
    <>
      ...
      {log && (
        <>
          <div class="custom-box show">
            <div class="custom-header">Log Out</div>
            <div class="custom-body">
              <p class="custom-message">Are you sure you want to log out?</p>
              <div class="custom-actions">
                <button class="custom-btn cancel" onClick={() => setLog(false)}>
                  Cancel
                </button>
